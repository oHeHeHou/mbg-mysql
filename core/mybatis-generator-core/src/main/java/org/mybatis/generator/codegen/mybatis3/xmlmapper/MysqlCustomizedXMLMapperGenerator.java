...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.DeleteBatchByPrimaryKeyElementGenerator;
...
public class MysqlCustomizedXMLMapperGenerator extends AbstractXmlGenerator {

    public MysqlCustomizedXMLMapperGenerator() {
        super();
    }
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addDeleteByBatchPrimaryKeyElement(answer);
...
//            AbstractXmlElementGenerator elementGenerator = new SimpleSelectByPrimaryKeyElementGenerator();
     ...
     * @param parentElement
     */
    protected void addDeleteByBatchPrimaryKeyElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateDeleteByPrimaryKey()) {
            AbstractXmlElementGenerator elementGenerator = new DeleteBatchByPrimaryKeyElementGenerator(true);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
