...
import org.mybatis.generator.codegen.mybatis3.javamapper.MysqlCustomizeJavaClientGenerator;
 ...
 *  针对Mysql数据库定制化的实现
 */
public class IntrospectedTableMysqlCustomizedImpl extends IntrospectedTableMyBatis3Impl {
    public IntrospectedTableMysqlCustomizedImpl() {
        super();
    }
    ...
    protected void calculateXmlMapperGenerator(AbstractJavaClientGenerator javaClientGenerator,
        ...
        if (javaClientGenerator == null) {
            if (context.getSqlMapGeneratorConfiguration() != null) {
                xmlMapperGenerator = new MysqlCustomizedXMLMapperGenerator();
            }
        } else {
    ...
    protected AbstractJavaClientGenerator createJavaClientGenerator() {
        ...
        if ("XMLMAPPER".equalsIgnoreCase(type)) { //$NON-NLS-1$
            javaGenerator = new MysqlCustomizeJavaClientGenerator(getClientProject());
